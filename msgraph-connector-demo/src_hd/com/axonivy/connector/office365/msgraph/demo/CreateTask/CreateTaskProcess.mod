...
' #txt
Cs0 f0 outParameterDecl '<msgraph.connector.NewToDo task> result;' #txt
...
>Proto Cs0 .type com.axonivy.connector.office365.msgraph.demo.CreateTask.CreateTaskData #txt
