...
public class GraphTestClient {
  ...
  public static final Map<String, String> REST_PROPERTIES = Map.of(Config.URL.property, GraphServiceMock.URI,
  ...
  public static void configureFixture(AppFixture fixture) {
    ...
    fixture.config(Config.FEATURES.property, List.of(CsrfHeaderFeature.class.getName(), JsonFeature.class.getName()));
  }
  ...
  public enum Config {
    FEATURES(REST_CLIENT_GRAPH_CLIENT.concat("Features")), URL(REST_CLIENT_GRAPH_CLIENT.concat("Url")),
