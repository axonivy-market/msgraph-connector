...
' #txt
Cs0 f0 outParameterDecl '<msgraph.connector.NewEvent event> result;' #txt
...
>Proto Cs0 .type com.axonivy.connector.office365.msgraph.demo.CreateEvent.CreateEventData #txt
