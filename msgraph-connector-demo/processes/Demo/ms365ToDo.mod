...
mo0 f14 processCall msToDo:allTasks() #txt
...
mo0 f2 processCall msToDo:createNewTask(msgraph.connector.NewToDo) #txt
mo0 f2 requestActionDecl '<msgraph.connector.NewToDo task> param;' #txt
...
>Proto mo0 .type com.axonivy.connector.office365.msgraph.demo.ToDoDemo #txt
